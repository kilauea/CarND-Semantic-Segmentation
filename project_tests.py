...
def test_layers(layers):
    ...
    layers_output = layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes, 1e-3)
...
def test_optimize(optimize):
    ...
    logits, train_op, cross_entropy_loss = optimize(layers_output, correct_label, learning_rate, num_classes, 1e-3)
